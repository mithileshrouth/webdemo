...
<html lang="en">
    ...
    <head>
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>application/assets/css/css_link/fullcalendar.css" />
		<link rel="stylesheet" href="<?php echo base_url(); ?>application/assets/css/css_link/matrix-style.css" />
		<link rel="stylesheet" href="<?php echo base_url(); ?>application/assets/css/css_link/matrix-media.css" />
		<link href="<?php echo base_url(); ?>application/assets/css/font-awesome/css/font-awesome.css" rel="stylesheet" />
		<link rel="stylesheet" href="<?php echo base_url(); ?>application/assets/css/css_link/jquery.gritter.css" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Demo Admin</a></h1>
</div>
<!--close-Header-part--> 
...
<!--End-Chart-box--> 
    ...
    <div class="row-fluid">
      ...
      <div class="span6">
        ...
        <script src="<?php echo base_url(); ?>application/assets/js/js_script/excanvas.min.js"></script> 
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.ui.custom.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/bootstrap.min.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.flot.min.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.flot.resize.min.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.peity.min.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/fullcalendar.min.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/matrix.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/matrix.dashboard.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.gritter.min.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/matrix.interface.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/matrix.chat.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.validate.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/matrix.form_validation.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.wizard.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.uniform.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/select2.min.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/matrix.popover.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/jquery.dataTables.min.js"></script> 
		<script src="<?php echo base_url(); ?>application/assets/js/js_script/matrix.tables.js"></script> 
